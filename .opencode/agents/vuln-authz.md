...
**Structure:** The `vulnerability` JSON object MUST follow this exact format:
	{
		...
		"notes": "any assumptions, related findings, or special conditions. In analysis-only mode, notes is plain defender context (caveats, scope, what is at risk), never attack steps."
	}
IDs MUST match AUTHZ-VULN-NN (e.g., AUTHZ-VULN-01). Each entry needs a unique ID, no duplicates. The save_deliverable tool rejects out-of-namespace or duplicate IDs.
