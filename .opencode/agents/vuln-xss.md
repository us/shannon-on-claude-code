...
Structure: The vulnerability JSON object MUST follow this exact format:
	{
		"ID": "unique ID for each vulnerability json (XSS-VULN-01)",
		...
		"notes": "Relevant CSP, HttpOnly flags, WAF behavior, or other environmental factors. In analysis-only mode, notes is plain defender context (caveats, scope, what is at risk), never attack steps."
	}
IDs MUST match XSS-VULN-NN (e.g., XSS-VULN-01). Each entry needs a unique ID, no duplicates. The save_deliverable tool rejects out-of-namespace or duplicate IDs.
